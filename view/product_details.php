        ...
        <div class="row">
            ...
            <div class="slideshow">
                <div class="main box-sadow">
                    <img src="./image/anh1.jpg" class="img_feature">
            ...
            -->
                <div class="dungluong_s">
                    ...
                    <div class="lineX"></div>
                    <div class="GB">
                        <span><input type="radio"> 256Gb </span>
                        <div class="gia">27.190.000 đ</div>
                    </div>
                    <div class="lineX"></div>
                    <div class="GB">
                        <span><input type="radio"> 512Gb </span>
                        <div class="gia">27.190.000 đ</div>
                    </div>
                    <div class="lineX"></div>
                    <div class="GB">
                        <span><input type="radio"> 1T </span>
                        <div class="gia">27.190.000 đ</div>
                    </div>
                </div>
                ...
                <div class="khuyenmai_sp mr20">
                    <div class="Uudai ">
                        <div class="Uudai1 mr10">
                            ...
                            <div class="input">
                                <input type="radio"> - Giảm ngay 2,800,000đ khi mua màu Tím ap dụng đến 20/11 <br>
                                <input type="radio" id="sp_km1">
